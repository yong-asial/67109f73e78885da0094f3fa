...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web-UUTVZQwG.js"), true ? __vite__mapDeps([]) : void 0, import.meta.url).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
window.customElements.define(
  ...
  class extends HTMLElement {
    ...
    <div>
      ...
      <main>
        <p>
          113Capacitor makes it easy to build powerful apps for the app stores, mobile web (Progressive Web Apps), and desktop, all
